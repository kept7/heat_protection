...
def heat_in_cooling_path_calc(
    ...
    for i in reversed(range(i_exit - 1, i_enter - 1)):
        while True:
            ...
            T_cp_2 = T_oxl_list[0] + 0.5 * delta_T_2
    ...
    U_oxl_list = [
        round(m_oxl / (f_list[i] * ro_oxl), 6) for _, ro_oxl in enumerate(rho_oxl_list)
    ]
